...
Matrix4x4 Inverce(const Matrix4x4& m1) {
	...
	result.m[0][0] = (m1.m[1][1] * m1.m[2][2] * m1.m[3][3] +
	                 ...
	                 determinantRecp;
	result.m[0][1] = (-m1.m[0][1] * m1.m[2][2] * m1.m[3][3] -
	                 ...
	                 determinantRecp;
	result.m[0][2] = (m1.m[0][1] * m1.m[1][2] * m1.m[3][3] +
	                 ...
	                 determinantRecp;
	result.m[0][3] = (-m1.m[0][1] * m1.m[1][2] * m1.m[2][3] -
	                 ...
	                 determinantRecp;
	result.m[1][0] = (-m1.m[1][0] * m1.m[2][2] * m1.m[3][3] -
	                 ...
	                 determinantRecp;
	result.m[1][1] = (m1.m[0][0] * m1.m[2][2] * m1.m[3][3] +
	                 ...
	                 determinantRecp;
	result.m[1][2] = (-m1.m[0][0] * m1.m[1][2] * m1.m[3][3] -
	                 ...
	                 determinantRecp;
	result.m[1][3] = (m1.m[0][0] * m1.m[1][2] * m1.m[2][3] +
	                 ...
	                 determinantRecp;
	result.m[2][0] = (m1.m[1][0] * m1.m[2][1] * m1.m[3][3] +
	                 ...
	                 determinantRecp;
	result.m[2][1] = (-m1.m[0][0] * m1.m[2][1] * m1.m[3][3] -
...
Vector3 Lerp(const Vector3& v1, const Vector3& v2, float t) { 
	...
	Vector3 result = Add(v1, Multiply(t, Subtruct(v2, v1)));
...
Vector3 Slerp(const Vector3& v1, const Vector3& v2, float t) { 
	...
	float v1P = sin(angle * (1 - t));
	float v2P = sin(angle * t);


	result.x = Add(Multiply(v1P, v1), Multiply(v2P, v2)).x / sinTheta;
	result.y = Add(Multiply(v1P, v1), Multiply(v2P, v2)).y / sinTheta;
	result.z = Add(Multiply(v1P, v1), Multiply(v2P, v2)).z / sinTheta;
